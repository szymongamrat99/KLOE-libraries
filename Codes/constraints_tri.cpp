...
Double_t ene_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value[6] = {999999., 999999., 999999., 999999., 999999., 999999.}, value_min, T0;
  ...
  TMath::Sort(6, value, ind_sort, kFALSE);

  value_min = value[ind_sort[0]];
  ...
  for (Int_t j = 0; j < 3; j++)
  {
    ...
    for (Int_t i = 0; i < 2; i++)
    {
      if (S.error[i] == 0)
      {
        ...
        value[i + 2 * j] = inv_mass_kaon - m_k0;
      }
      else
      {
        value[i + 2 * j] = 999999.;
...
Double_t x_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value[2] = {999999., 999999.}, value_min;
...
Double_t z_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value[2] = {999999., 999999.}, value_min, T0;
...
Double_t gamma1_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value = p[3] - (gamma_path / c_vel) - (kaon_path / kaon_vel_tot);
  return value;
}
...
Double_t gamma2_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value = p[8] - (gamma_path / c_vel) - (kaon_path / kaon_vel_tot);
  return value;
}
...
Double_t gamma3_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value = p[13] - (gamma_path / c_vel) - (kaon_path / kaon_vel_tot);
  return value;
}
...
Double_t gamma4_consv(Double_t *x, Double_t *p)
{
  ...
  Double_t value = p[18] - (gamma_path / c_vel) - (kaon_path / kaon_vel_tot);
  return value;
}